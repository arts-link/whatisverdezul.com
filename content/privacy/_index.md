...
description: "How Verdèzul handles the information collected through whatisverdezul.com — analytics, contact form, and mailing list."
date: 2026-07-30
---
...
We collect three things: anonymous statistics about how the site is used, whatever
you type into the contact form, and your email address if you choose to join the
mailing list. We don't sell any of it, we don't run ads, and we don't share it with
anyone beyond the services listed below that make the site work.
...
browser, and its own privacy policy applies to whatever happens inside the player.
We use YouTube's `youtube-nocookie.com` domain so nothing is stored until you
actually press play.

## Hosting

The site is hosted by **Vercel**, which keeps standard server logs (IP address,
browser type, page requested) for a short period as part of running any website
securely.

## Cookies

We set no advertising cookies and no cross-site tracking cookies. The only browser
